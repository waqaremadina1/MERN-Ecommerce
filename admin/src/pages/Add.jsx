    ...
    <form onSubmit={handleSubmit} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input onChange={(e) => setPrice(e.target.value)} value={price} type="number" placeholder='Price in $' className='w-full px-3 py-2 sm:w-[120px] ' />
        </div>
      </div>
      ...
      <button type='submit' className='w-28 py-3 rounded-md mt-4 bg-black text-white cursor-pointer'>ADD</button>
    </form>
  )
}
